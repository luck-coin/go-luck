...
func (abi ABI) Unpack(v interface{}, name string, data []byte) (err error) {
	...
	// we need to decide whforter we're calling a method or an event
...
// HasFallback returns an indicator whforter a fallback function is included.
func (abi *ABI) HasFallback() bool {
	return abi.Fallback.IsFallback
}

// HasReceive returns an indicator whforter a receive function is included.
