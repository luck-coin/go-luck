...
func TestSimulatedBackend(t *testing.T) {
	...
	if err != luck.NotFound {
		t.Fatalf("err should be `luck.NotFound` but received %v", err)
	}
...
func TestSimulatedBackend_EstimateGas(t *testing.T) {
	...
	gas, err := sim.EstimateGas(bgCtx, luck.CallMsg{
		From:  testAddr,
		To:    &testAddr,
...
func TestSimulatedBackend_PendingAndCallContract(t *testing.T) {
	...
	res, err := sim.PendingCallContract(bgCtx, luck.CallMsg{
		From: testAddr,
		To:   &addr,
		Data: input,
	})
	...
	res, err = sim.CallContract(bgCtx, luck.CallMsg{
		From: testAddr,
		To:   &addr,
		Data: input,
	}, nil)
