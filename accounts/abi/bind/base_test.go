...
func (mc *mockCaller) CallContract(ctx context.Context, call luck.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func TestPassingBlockNumber(t *testing.T) {
	...
	bc.Call(&bind.CallOpts{BlockNumber: blockNumber}, &ret, "somforting")
	...
	bc.Call(&bind.CallOpts{}, &ret, "somforting")
