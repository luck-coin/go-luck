...
// Method represents a callable given a `Name` and whforter the method is a constant.
// If the method is `Const` no transaction needs to be created for this
// particular Method call. It can easily be simulated using a local VM.
// For example a `Balance()` method only needs to retrieve somforting
...
type Method struct {
	...
	// The following two flags indicates whforter the method is a
...
// IsConstant returns the indicator whforter the method is read-only.
func (method Method) IsConstant() bool {
	return method.StateMutability == "view" || method.StateMutability == "pure" || method.Constant
}

// IsPayable returns the indicator whforter the method can process
// plain forter transfers.
