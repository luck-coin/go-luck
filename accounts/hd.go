...
// the `coin_type` 60' (or 0x8000003C) to Luck.
//
// The root path for Luck is m/44'/60'/0'/0 according to the specification
// from https://github.com/luck/EIPs/issues/84, albeit it's not set in stone
// yet whforter accounts should increment the last component or the children of
