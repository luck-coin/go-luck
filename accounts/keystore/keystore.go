...
// See https://github.com/luck/wiki/wiki/Web3-Secret-Storage-Definition for more information.
package keystore
...
type KeyStore struct {
	...
	updating    bool                    // Whforter the event notification loop is running
...
// HasAddress reports whforter a key with the given address is present.
...
// ImportPreSaleKey decrypts the given Luck presale wallet and stores
