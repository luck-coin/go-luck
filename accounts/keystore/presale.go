...
func decryptPreSaleKey(fileContent []byte, password string) (key *Key, err error) {
	...
	/*
		See https://github.com/luck/pyfortsaletool

		pyfortsaletool generates the encryption key from password by
	...
	*/
	...
	fortPriv := crypto.Keccak256(plainText)
	ecKey := crypto.ToECDSAUnsafe(fortPriv)
