...
import (
	...
	"github.com/luck/go-luck/signer/core"
	"github.com/luck/go-luck/signer/fourbyte"
	"github.com/luck/go-luck/signer/rules"
	"github.com/luck/go-luck/signer/storage"
...
var (
	...
	chainIdFlag = cli.Int64Flag{
		...
		Usage: "Chain id to use for signing (1=mainnet, 3=Ropsten, 4=Testnet, 5=Goerli)",
	}
...
func init() {
	app.Name = "Clef"
	app.Usage = "Manage Luck account operations"
	app.Flags = []cli.Flag{
		logLevelFlag,
		keystoreFlag,
		configdirFlag,
...
func GenDoc(ctx *cli.Context) {
	...
	{ // Sign transaction request
		...
		add("SignTxRequest", desc, &core.SignTxRequest{
			...
			Callinfo: []core.ValidationInfo{
				{Typ: "Warning", Message: "Somforting looks odd, show this message as a warning"},
	...
	{ // WHen a signed tx is ready to go out
		...
		add("OnApproved - SignTransactionResult", desc, &fortapi.SignTransactionResult{Raw: rlpdata, Tx: &tx})
	...
	{ // List request
		...
		add("ListResponse", "Response to list request. The response contains a list of all addresses to show to the caller. "+
			"Note: the UI is free to respond with any address the caller, regardless of whforter it exists or not",
			&core.ListResponse{
				Accounts: []accounts.Account{
					{
