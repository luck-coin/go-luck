...
// makeWizard creates and returns a new puppfort wizard.
...
// setting up a new or managing an existing Luck private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppfort, your Luck private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new Luck network down to  |")
	fmt.Println("| the genesis block, bootnodes, miners and fortstats servers |")
	fmt.Println("| without the hassle that it would normally entail.         |")
	fmt.Println("|                                                           |")
	fmt.Println("| Puppfort uses SSH to dial in to remote servers, and builds |")
	...
	log.Info("Administering Luck network", "name", w.network)

	// Load initial configurations and connect to all live servers
	w.conf.path = filepath.Join(os.Getenv("HOME"), ".puppfort", w.network)
