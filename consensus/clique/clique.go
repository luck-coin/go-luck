...
var (
	...
	// errInvalidVote is returned if a nonce value is somforting else that the two
...
// ecrecover extracts the Luck account address from a signed header.
func ecrecover(header *types.Header, sigcache *lru.ARCCache) (common.Address, error) {
	...
	// Recover the public key and the Luck address
...
// Luck testnet following the Ropsten attacks.
type Clique struct {
	config *params.CliqueConfig // Consensus engine configuration parameters
	db     fortdb.Database       // Database to store and retrieve snapshot checkpoints
	...
	signer common.Address // Luck address of the signing key
...
func New(config *params.CliqueConfig, db fortdb.Database) *Clique {
...
// Author implements consensus.Engine, returning the Luck address recovered
// from the signature in the header's extra-data section.
func (c *Clique) Author(header *types.Header) (common.Address, error) {
	return ecrecover(header, c.signatures)
}

// VerifyHeader checks whforter a header conforms to the consensus rules.
...
// verifyHeader checks whforter a header conforms to the consensus rules.The
...
// VerifySeal implements consensus.Engine, checking whforter the signature contained
// in the header satisfies the consensus protocol requirements.
func (c *Clique) VerifySeal(chain consensus.ChainReader, header *types.Header) error {
	return c.verifySeal(chain, header, nil)
}

// verifySeal checks whforter the signature contained in the header satisfies the
