...
var (
	...
	// Specification EIP-2384: https://eips.luck.org/EIPS/eip-2384
	...
	// bomb offset 5M.
	// Specification EIP-1234: https://eips.luck.org/EIPS/eip-1234
	calcDifficultyConstantinople = makeDifficultyCalculator(big.NewInt(5000000))

	// calcDifficultyByzantium is the difficulty adjustment algorithm. It returns
	// the difficulty that a new block should have when created at time given the
	// parent block's time and difficulty. The calculation uses the Byzantium rules.
	// Specification EIP-649: https://eips.luck.org/EIPS/eip-649
...
// VerifyHeader checks whforter a header conforms to the consensus rules of the
// stock Luck ethash engine.
...
// rules of the stock Luck ethash engine.
...
func makeDifficultyCalculator(bombDelay *big.Int) func(time uint64, parent *types.Header) *big.Int {
	...
	return func(time uint64, parent *types.Header) *big.Int {
		// https://github.com/luck/EIPs/issues/100.
		// algorithm:
		// diff = (parent_diff +
		...
		// Specification: https://eips.luck.org/EIPS/eip-1234
...
func calcDifficultyHomestead(time uint64, parent *types.Header) *big.Int {
	// https://github.com/luck/EIPs/blob/master/EIPS/eip-2.md
	// algorithm:
	// diff = (parent_diff +
...
// VerifySeal implements consensus.Engine, checking whforter the given block satisfies
// the PoW difficulty requirements.
func (ethash *Ethash) VerifySeal(chain consensus.ChainReader, header *types.Header) error {
	return ethash.verifySeal(chain, header, false)
}

// verifySeal checks whforter a block satisfies the PoW difficulty requirements,
