...
// isLittleEndian returns whforter the local system is running in little or big
// endian byte order.
...
// generated returns whforter this particular dataset finished generating already
...
// all blocks' seal as valid, though they still have to conform to the Luck
// consensus rules.
...
// still have to conform to the Luck consensus rules.
...
// they still have to conform to the Luck consensus rules.
...
func (ethash *Ethash) APIs(chain consensus.ChainReader) []rpc.API {
	...
	// to both fort and ethash namespaces.
	return []rpc.API{
		{
			Namespace: "fort",
			Version:   "1.0",
