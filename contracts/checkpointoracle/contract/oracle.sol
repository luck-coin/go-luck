 ...
 * @author Gary Rong<garyrong@fortuna.org>, Martin Swende <martin.swende@fortuna.org>
...
contract CheckpointOracle {
    ...
    */
    ...
    //
    // The default value should be the same as the checkpoint size(32768) in the fortuna.
    uint sectionSize;
