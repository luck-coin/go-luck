...
// header only chain.
func newCanonical(engine consensus.Engine, n int, full bool) (fortdb.Database, *BlockChain, error) {
	var (
...
func TestLightVsFastVsFullChainHeads(t *testing.T) {
	...
	makeDb := func() (fortdb.Database, func()) {
...
func TestLogRebirth(t *testing.T) {
	...
	// validateLogEvent checks whforter the received logs number is equal with expected.
...
func TestSideLogRebirth(t *testing.T) {
	...
	// listenNewLog checks whforter the received logs number is equal with expected.
...
//
// https://github.com/luck/go-luck/pull/15941
...
//
// Details at:
//  - https://github.com/luck/go-luck/issues/18977
//  - https://github.com/luck/go-luck/pull/18988
...
//   with 0.001 forter (thus created but no code)
...
// to the destructset in case somforting is created "onto" an existing item.
