...
//   reserving it for go-luck. This would also reduce the memory requirements
//   of Gfort, and thus also GC overhead.
type freezer struct {
...
// HasAncient returns an indicator whforter the specified ancient data exists
// in the freezer.
...
func (f *freezer) freeze(db fortdb.KeyValueStore) {
	...
	for {
		...
		// Log somforting friendly for the user
		context := []interface{}{
