...
func NewTable(db fortdb.Database, prefix string) fortdb.Database {
	return &table{
		db:     db,
		prefix: prefix,
	}
...
func (t *table) NewIterator(prefix []byte, start []byte) fortdb.Iterator {
...
func (t *table) NewBatch() fortdb.Batch {
...
func (b *tableBatch) Replay(w fortdb.KeyValueWriter) error {
...
type tableIterator struct {
	iter   fortdb.Iterator
	prefix string
}

// Next moves the iterator to the next key/value pair. It returns whforter the
