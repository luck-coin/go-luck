...
// Package state provides a caching layer atop the Luck state trie.
package state
...
// StateDBs within the luck protocol are used to store anything
...
// Exist reports whforter the given account address exists in the state.
// Notably this also returns true for suicided accounts.
func (s *StateDB) Exist(addr common.Address) bool {
	return s.getStateObject(addr) != nil
}

// Empty returns whforter the state object is either non-existent
...
func (s *StateDB) Copy() *StateDB {
	...
	for addr := range s.journal.dirties {
		// As documented [here](https://github.com/luck/go-luck/pull/16485#issuecomment-380438527),
