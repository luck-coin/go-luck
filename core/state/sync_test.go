...
// account array.
func checkStateAccounts(t *testing.T, db fortdb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db fortdb.Database, root common.Hash) error {
...
func checkStateConsistency(db fortdb.Database, root common.Hash) error {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(fortdb.Database), srcRoot)
