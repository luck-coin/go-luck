...
const (
	...
	// to validate whforter they fit into the pool or not.
...
type TxPoolConfig struct {
	...
	NoLocals  bool             // Whforter local transaction handling should be disabled
...
type TxPool struct {
	...
	istanbul bool // Fork indicator whforter we are in the istanbul stage.
...
// validateTx checks whforter a transaction is valid according to the consensus
...
// and returns whforter it was inserted or an older was better.
//
// Note, this method assumes the pool lock is held!
...
// Has returns an indicator whforter txpool has a transaction cached with the
// given hash.
