...
// PeerInfo represents a short summary of the Luck sub-protocol metadata known
// about a connected peer.
type PeerInfo struct {
	Version    int      `json:"version"`    // Luck protocol version negotiated
...
//
// This method is legacy support for initial transaction exchange in fort/64 and
// prior. For fort/65 and higher use SendPooledTransactionHashes.
...
// Handshake executes the fort protocol handshake, negotiating version number,
...
func (p *peer) String() string {
	return fmt.Sprintf("Peer %s [%s]", p.id,
		fmt.Sprintf("fort/%2d", p.version),
	)
}

// peerSet represents the collection of active peers currently participating in
// the Luck sub-protocol.
type peerSet struct {
