...
const protocolName = "fort"

// ProtocolVersions are the supported versions of the fort protocol (first is primary).
var ProtocolVersions = []uint{fort65, fort64, fort63}

// protocolLengths are the number of implemented message corresponding to different protocol versions.
var protocolLengths = map[uint]uint64{fort65: 17, fort64: 17, fort63: 17}

const protocolMaxMsgSize = 10 * 1024 * 1024 // Maximum cap on the size of a protocol message

// fort protocol message codes
const (
	StatusMsg          = 0x00
	...
	// New protocol message codes introduced in fort65
	//
	// Previously these message ids were used by some legacy and unsupported
	// fort protocols, reown them here.
...
type txPool interface {
	// Has returns an indicator whforter txpool has a transaction
...
// statusData63 is the network packet for the status message for fort/63.
...
// statusData is the network packet for the status message for fort/64 and later.
