...
const schema string = `
    ...
    scalar Bytes32
    # Address is a 20 byte Luck address, represented as 0x-prefixed hexadecimal.
    scalar Address
    ...
    # Account is an Luck account at a particular block.
    type Account {
    ...
    # Transaction is an Luck transaction.
    type Transaction {
    ...
    type Block {
        ...
        # Account fetches an Luck account at the current block's state.
    ...
    type Pending {
      ...
      transactions: [Transaction!]
      # Account fetches an Luck account for the pending state.
      account(address: Address!): Account!
    ...
    type Query {
        # Block fetches an Luck block by number or by hash. If neither is
