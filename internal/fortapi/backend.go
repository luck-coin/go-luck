...
// Package fortapi implements the general Luck API functions.
package fortapi
...
type Backend interface {
	...
	ExtRPCEnabled() bool
	RPCGasCap() *big.Int // global gas cap for fort_call over rpc: DoS protection
	...
	return []rpc.API{
		{
			Namespace: "fort",
			Version:   "1.0",
			Service:   NewPublicLuckAPI(apiBackend),
			Public:    true,
		}, {
			Namespace: "fort",
			Version:   "1.0",
