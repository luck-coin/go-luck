...
func (api *PrivateLightServerAPI) ClientInfo(ids []lnode.ID) map[lnode.ID]map[string]interface{} {
	res := make(map[lnode.ID]map[string]interface{})
	api.server.clientPool.forClients(ids, func(client *clientInfo, id lnode.ID) error {
...
// assigned to it.
func (api *PrivateLightServerAPI) PriorityClientInfo(start, stop lnode.ID, maxCount int) map[lnode.ID]map[string]interface{} {
	res := make(map[lnode.ID]map[string]interface{})
...
func (api *PrivateLightServerAPI) clientInfo(c *clientInfo, id lnode.ID) map[string]interface{} {
...
func (api *PrivateLightServerAPI) AddBalance(id lnode.ID, value int64, meta string) ([2]uint64, error) {
...
func (api *PrivateLightServerAPI) SetClientParams(ids []lnode.ID, params map[string]interface{}) error {
	return api.server.clientPool.forClients(ids, func(client *clientInfo, id lnode.ID) error {
		if client != nil {
...
func (api *PrivateDebugAPI) FreezeClient(id lnode.ID) error {
	return api.server.clientPool.forClients([]lnode.ID{id}, func(c *clientInfo, id lnode.ID) error {
		if c == nil {
			return fmt.Errorf("client %064x is not connected", id[:])
		}
		c.peer.freezeClient()
