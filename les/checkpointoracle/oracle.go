...
type CheckpointOracle struct {
	...
	running  int32                                 // Flag whforter the contract backend is set or not
...
// IsRunning returns an indicator whforter the oracle is running.
...
// checks whforter there are enough approvals to finalize the checkpoint.
