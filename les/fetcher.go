...
// the necessary amount to request and whforter a downloader sync is necessary instead of a normal header request.
...
// adds it to the end of a linked list tolucker with the time it has been confirmed. Then checks which peers have
