...
func connect(server *serverHandler, serverId lnode.ID, client *clientHandler, protocol int) (*serverPeer, *clientPeer, error) {
...
func newTestServerPeer(t *testing.T, blocks int, protocol int) (*testServer, *lnode.Node, func()) {
	...
	n := lnode.NewV4(&key.PublicKey, net.ParseIP("127.0.0.1"), 35000, 35000)
	return s, n, teardown
}
