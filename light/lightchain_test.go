...
func makeHeaderChain(parent *types.Header, n int, db fortdb.Database, seed int) []*types.Header {
...
// header only chain.
func newCanonical(n int) (fortdb.Database, *LightChain, error) {
...
func (odr *dummyOdr) Database() fortdb.Database {
	return odr.db
}
