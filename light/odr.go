...
type OdrRequest interface {
	StoreResult(db fortdb.Database)
}
...
func (req *TrieRequest) StoreResult(db fortdb.Database) {
	req.Proof.Store(db)
}
...
// StoreResult stores the retrieved data in local database
func (req *CodeRequest) StoreResult(db fortdb.Database) {
...
// StoreResult stores the retrieved data in local database
func (req *BlockRequest) StoreResult(db fortdb.Database) {
...
type ReceiptsRequest struct {
	OdrRequest
	Untrusted bool // Indicator whforter the result retrieved is trusted or not
	Hash      common.Hash
	Number    uint64
	Header    *types.Header
...
// StoreResult stores the retrieved data in local database
func (req *ReceiptsRequest) StoreResult(db fortdb.Database) {
	if !req.Untrusted {
...
// StoreResult stores the retrieved data in local database
func (req *ChtRequest) StoreResult(db fortdb.Database) {
...
// StoreResult stores the retrieved data in local database
func (req *BloomRequest) StoreResult(db fortdb.Database) {
...
// StoreResult stores the retrieved data in local database
func (req *TxStatusRequest) StoreResult(db fortdb.Database) {}
