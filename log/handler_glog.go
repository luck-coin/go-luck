...
type GlogHandler struct {
	...
	override  uint32 // Flag whforter overrides are used, atomically accessible
	backtrace uint32 // Flag whforter backtrace location is set
...
func (h *GlogHandler) Log(r *Record) error {
	// If backtracing is requested, check whforter this is the callsite
