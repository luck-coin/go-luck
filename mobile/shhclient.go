...
import (
	"github.com/luck/go-luck/whisper/shhclient"
	whisper "github.com/luck/go-luck/whisper/whisperv6"
)

// WhisperClient provides access to the Luck APIs.
...
func (wc *WhisperClient) MarkTrustedPeer(ctx *Context, lnode string) error {
	return wc.client.MarkTrustedPeer(ctx.context, lnode)
}
