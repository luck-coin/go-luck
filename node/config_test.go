...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "luck.ipc", false, filepath.Join(os.TempDir(), "luck.ipc")},
		{"data", "luck.ipc", false, "data/luck.ipc"},
		{"data", "./luck.ipc", false, "./luck.ipc"},
		{"data", "/luck.ipc", false, "/luck.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "luck.ipc", true, `\\.\pipe\luck.ipc`},
		{"data", "luck.ipc", true, `\\.\pipe\luck.ipc`},
		{"data", `\\.\pipe\luck.ipc`, true, `\\.\pipe\luck.ipc`},
	}
