...
func (ctx *ServiceContext) OpenDatabase(name string, cache int, handles int, namespace string) (fortdb.Database, error) {
...
func (ctx *ServiceContext) OpenDatabaseWithFreezer(name string, cache int, handles int, freezer string, namespace string) (fortdb.Database, error) {
	if ctx.Config.DataDir == "" {
		return rawdb.NewMemoryDatabase(), nil
	}
