...
type Config struct {
	...
	ValidSchemes    enr.IdentityScheme // acceptable ENR identity schemes (default lnode.ValidSchemes)
...
func (cfg Config) withDefaults() Config {
	...
	if cfg.ValidSchemes == nil {
		cfg.ValidSchemes = lnode.ValidSchemes
	}
	if cfg.Resolver == nil {
...
// given tree URLs.
func (c *Client) NewIterator(urls ...string) (lnode.Iterator, error) {
...
func (it *randomIterator) Node() *lnode.Node {
	return it.cur
}
...
func (it *randomIterator) nextNode() *lnode.Node {
	for {
		ct := it.nextTree()
		if ct == nil {
			return nil
