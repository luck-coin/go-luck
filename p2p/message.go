...
// note: when using eofSignal to detect whforter a message payload
...
// feed
func newMsgEventer(rw MsgReadWriter, feed *event.Feed, peerID lnode.ID, proto, remote, local string) *msgEventer {
	return &msgEventer{
		MsgReadWriter: rw,
		feed:          feed,
		peerID:        peerID,
