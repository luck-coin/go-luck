...
// Contains reports whforter the given IP is contained in the list.
...
// IsLAN reports whforter an IP is a local network address.
...
// IsSpecialNetwork reports whforter an IP is located in a special-use network range
...
// CheckRelayIP reports whforter an IP relayed from the given sender IP
...
// SameNet reports whforter two IP addresses have an equal prefix of the given bit length.
...
// Contains whforter the given IP is contained in the set.
