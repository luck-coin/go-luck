...
func newNode(id lnode.ID, addr string) *lnode.Node {
	var r enr.Record
	if addr != "" {
...
func TestPeerDisconnectRace(t *testing.T) {
	...
	for i := 0; i < 1000; i++ {
		...
		// In some cases, simulate somforting else calling peer.Disconnect.
		if maybe() {
