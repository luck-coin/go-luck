...
import (
	...
	"github.com/luck/go-luck/crypto/ecies"
...
// and also verifies whforter the encryption handshake 'worked' and the
...
type authMsgV4 struct {
	gotPlain bool // whforter read packet had plain format.
