...
func (net *Network) ConnectToLastNode(id lnode.ID) (err error) {
	net.lock.Lock()
...
func (net *Network) ConnectToRandomNode(id lnode.ID) (err error) {
	net.lock.Lock()
	defer net.lock.Unlock()
...
func (net *Network) ConnectNodesFull(ids []lnode.ID) (err error) {
	net.lock.Lock()
	defer net.lock.Unlock()
...
func (net *Network) ConnectNodesChain(ids []lnode.ID) (err error) {
	net.lock.Lock()
	defer net.lock.Unlock()
...
// If ids argument is nil, all nodes that are up will be connected.
func (net *Network) ConnectNodesRing(ids []lnode.ID) (err error) {
	net.lock.Lock()
	defer net.lock.Unlock()
...
// If ids argument is nil, all nodes that are up will be connected.
func (net *Network) ConnectNodesStar(ids []lnode.ID, center lnode.ID) (err error) {
	net.lock.Lock()
	defer net.lock.Unlock()
...
func (net *Network) connectNotConnected(oneID, otherID lnode.ID) error {
