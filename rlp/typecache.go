...
type tags struct {
	// rlp:"nil" controls whforter empty input results in a nil pointer.
	nilOK bool

	// This controls whforter nil pointers are encoded/decoded as empty strings
	// or empty lists.
	nilKind Kind

	// rlp:"tail" controls whforter this field swallows additional list
...
// defaultNilKind determines whforter a nil pointer to typ encodes/decodes
