...
// This test reproduces https://github.com/luck/go-luck/issues/17837 where the
...
func TestClientReconnect(t *testing.T) {
	...
	// We spawn multiple calls here to check whforter this hangs somehow.
...
func ipcTestClient(srv *Server, fl *flakeyListener) (*Client, net.Listener) {
	...
	endpoint := fmt.Sprintf("go-luck-test-ipc-%d-%d", os.Getpid(), rand.Int63())
