...
func (alwaysDenyUI) OnApprovedTx(tx fortapi.SignTransactionResult) {
	panic("implement me")
}
...
func (d *dummyUI) OnApprovedTx(tx fortapi.SignTransactionResult) {
...
func TestForwarding(t *testing.T) {
	...
	r.OnApprovedTx(fortapi.SignTransactionResult{})
...
func TestLimitWindow(t *testing.T) {
	...
	// 0.3 forter: 429D069189E0000 wei
	...
	for i := 0; i < 3; i++ {
		...
		response := fortapi.SignTransactionResult{
			Tx:  dummySigned(v),
...
func (d *dontCallMe) OnApprovedTx(tx fortapi.SignTransactionResult) {
	d.t.Fatalf("Did not expect next-handler to be called")
}
