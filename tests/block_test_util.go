...
// Package tests implements execution of Luck JSON tests.
package tests
...
/* See https://github.com/luck/tests/wiki/Blockchain-Tests-II

   Whforter a block is valid or not is a bit subtle, it's defined by presence of
