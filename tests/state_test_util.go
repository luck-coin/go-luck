...
// See https://github.com/luck/EIPs/issues/176 for the test format specification.
...
func MakePreState(db fortdb.Database, accounts core.GenesisAlloc, snapshotter bool) *state.StateDB {
...
func (tx *stTransaction) toMessage(ps stPostState) (core.Message, error) {
	...
	// Value, Data hex encoding is messy: https://github.com/luck/tests/issues/203
	value := new(big.Int)
	if valueHex != "0x" {
