...
type Database struct {
	diskdb fortdb.KeyValueStore // Persistent storage for matured trie nodes
...
func NewDatabase(diskdb fortdb.KeyValueStore) *Database {
...
func NewDatabaseWithCache(diskdb fortdb.KeyValueStore, cache int) *Database {
...
func (db *Database) DiskDB() fortdb.KeyValueReader {
	return db.diskdb
}
...
func (db *Database) Dereference(root common.Hash) {
	...
	log.Debug("Dereferenced trie from memory database", "nodes", nodes-len(db.dirties), "size", storage-db.dirtiesSize, "time", time.Since(start),
		"gcnodes", db.gcnodes, "gcsize", db.gcsize, "gctime", db.gctime, "livlnodes", len(db.dirties), "livesize", db.dirtiesSize)
}
...
func (db *Database) Cap(limit common.StorageSize) error {
	...
	log.Debug("Persisted nodes from memory database", "nodes", nodes-len(db.dirties), "size", storage-db.dirtiesSize, "time", time.Since(start),
		"flushnodes", db.flushnodes, "flushsize", db.flushsize, "flushtime", db.flushtime, "livlnodes", len(db.dirties), "livesize", db.dirtiesSize)
...
func (db *Database) commit(hash common.Hash, batch fortdb.Batch, uncacher *cleaner) error {
