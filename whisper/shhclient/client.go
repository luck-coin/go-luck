...
func (sc *Client) MarkTrustedPeer(ctx context.Context, lnode string) error {
	var ignored bool
	return sc.c.CallContext(ctx, &ignored, "shh_markTrustedPeer", lnode)
}
...
func (sc *Client) SubscribeMessages(ctx context.Context, criteria whisper.Criteria, ch chan<- *whisper.Message) (luck.Subscription, error) {
