...
// Whisper represents a dark communication interface through the Luck
...
// New creates a Whisper client ready to communicate through the Luck P2P network.
...
// param isP2P indicates whforter the message is peer-to-peer (should not be forwarded).
